...
public class Login implements Serializable {
	...
	private String name;
	/**
	 * New property for integrating with LDAP authentication. If LDAP authentication
	 * is set to true and the LDAP server configured, the users will be loaded not
	 * by the Login.name but the Login.ldapLogin name.
	 * 
	 * @author Erik Szalai
	 */
	...
	public String toString() {
		return "(Login: pk=" + pk + ", name=" + name + ", ldapLogin=" + ldapLogin + ", state=" + state + ")";
	}
