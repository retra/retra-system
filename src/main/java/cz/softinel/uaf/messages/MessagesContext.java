...
/**
 * Context for holding {@link Messages} object. Use this context to access
 * current messages.
 * 
 * <p>
 * The default implementation {@link DefaultMessagesContext} uses a thread local
 * variable to hold the current messages object. For remoting purposes there
 * would have to be an extension to a remote invocation to transfer the messages
 * and to set it to the remote thread local.
 *
