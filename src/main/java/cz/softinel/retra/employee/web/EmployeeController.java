...
public class EmployeeController extends CommonDispatchController {
	...
	/**
	 * Comparator added to correct the bug RTR-10. This will compare user names by
	 * the first name. Check the implementation {@link EmployeeNameComparator}.
	 */
	...
	public ModelAndView employeeView(Model model, RequestContext requestContext) {
		...
		if (pk != null) {
			// TODO: must be check if user is deleting his worklog and not someone others -
			// maybe in logic
