 ...
 * <p>
 * Known implementation: {@link JiraSoapClientImpl}
 * 
 * @author Erik Szalai
...
public interface JiraSoapClient {
	...
	/**
	 * Export the updated JiraWorklogs. Updated where the details but not the Jira
	 * issue field.
	 * 
	...
	/**
	 * Delete all the JiraWorklogs where the Worklog was deleted (the
	 * {@link JiraWorklog#getWorklog()} returns null).
	 */
	void exportDeleted();
