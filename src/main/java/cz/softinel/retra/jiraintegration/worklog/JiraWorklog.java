...
public class JiraWorklog {
	...
	/**
	 * This is used when the Jira issue field is modified for an existing worklog.
	 * Then a delete and update are needed.
	 */
	public static final int ISSUE_UPDATED = 3;
	/**
	 * This is used when the jira issue field is updated and the new Jira issue does
	 * not exist.
	 */
	...
	/**
	 * Get the ID of the worklog given by the remote Jira and saved when the worklog
	 * was added.
	 * 
	 * @return
	 */
	...
	/**
	 * Set the worklog ID, which shall be got from the remote Jira, when adding or
