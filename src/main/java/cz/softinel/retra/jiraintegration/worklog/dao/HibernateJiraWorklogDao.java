...
public class HibernateJiraWorklogDao extends HibernateDaoSupport implements JiraWorklogDao {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cz.softinel.retra.jiraintegration.worklog.dao.JiraWorklogDao#insert(cz.
	 * softinel.retra.jiraintegration.worklog.JiraWorklog)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cz.softinel.retra.jiraintegration.worklog.dao.JiraWorklogDao#
	 * selectAllNotAdded()
	 */
	 ...
	 * 
	 * @see
	 * cz.softinel.retra.jiraintegration.worklog.dao.JiraWorklogDao#selectByState(
	 * int)
	 */
	@SuppressWarnings("unchecked")
	 ...
	 * 
	 * @see
	 * cz.softinel.retra.jiraintegration.worklog.dao.JiraWorklogDao#selectByStates(
	 * java.lang.Object[])
	 */
	@SuppressWarnings("unchecked")
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cz.softinel.retra.jiraintegration.worklog.dao.JiraWorklogDao#update(cz.
	 * softinel.retra.jiraintegration.worklog.JiraWorklog)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cz.softinel.retra.jiraintegration.worklog.dao.JiraWorklogDao#delete(cz.
	 * softinel.retra.jiraintegration.worklog.JiraWorklog)
	 */
