...
/**
 * Manager class for working with JiraWorklogs. The Jira SOAP import methods
 * where moved to {@link JiraSoapClient}.
 * 
...
public class JiraWorklogLogicImpl implements JiraWorklogLogic {
	 ...
	 * 
	 * @see
	 * cz.softinel.retra.jiraintegration.worklog.service.JiraWorklogLogic#create(cz.
	 ...
	 * 
	 * @see
	 * cz.softinel.retra.jiraintegration.worklog.service.JiraWorklogLogic#update(cz.
	 * softinel.retra.jiraintegration.worklog.JiraWorklog)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cz.softinel.retra.jiraintegration.worklog.service.JiraWorklogLogic#
	 * findAllNotAdded()
	 */
...
//		Object [] states = new Object[] {JiraWorklog.ISSUE_UPDATED, JiraWorklog.EXPORTED_FOR_NONEXISTENT };
	 ...
	 * 
	 * @see
	 * cz.softinel.retra.jiraintegration.worklog.service.JiraWorklogLogic#delete(cz.
	 * softinel.retra.jiraintegration.worklog.JiraWorklog)
	 */
