...
public interface JiraWorklogLogic {
	...
	/**
	 * This method returns all the jiraworklog elements to an edited retra worklog whi
	 * @return
	 */
	...
	/**
	 * Will find all JiraWorklogs where the worklog reference is null (must be deleted).
	 * @return
	 */
