...
public class ScheduleCopyValidator implements Validator {
	...
	public void validate(Object command, Errors errors) {
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "copyDestinationFrom",
				"scheduleForm.copyDestinationFrom.required");
		CommonValidator.validateDate("copyDestinationFrom", errors, "scheduleForm.copyDestinationFrom.bad.format",
				null);

		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "copyDestinationTo",
				"scheduleForm.copyDestinationTo.required");
