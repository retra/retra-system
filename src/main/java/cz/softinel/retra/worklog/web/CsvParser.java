...
public class CsvParser extends LineBasedParser {
	...
	public Worklog parseWorklogItemByToken(String[] tokens, Map<String, ProjectInvoiceHolder> projectMapping,
		...
		try {
			...
			// Date,Project
			// Code,Component,Activity,Invoice,Employee,Description,From,To,Hours
