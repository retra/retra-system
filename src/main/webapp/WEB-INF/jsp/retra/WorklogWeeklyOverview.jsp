...
<c:set var="requestURI" value="WorklogWeeklyOverview.do?fkprm=true" />
...
<form action="${requestURI}" method="post" >
	...
	<table class="filterTable">
		<tr>
			...
			<td rowspan="3" class="buttons"><input type="submit" class="button" name="filter" value="<fmt:message key="button.filter"/>" tabindex="6"/></td>
		</tr>
		<tr>
